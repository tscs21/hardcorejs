...
var firstTitle = _.compose(get('name'),get('author'), _.head);
...
var names = _.map(_.compose(get('name'), get('author'))); //answer #1
assertEqualArrays(
...
var avg = fork(_.divide, _.sum, _.size); // answer#3
...
log(firstTitle(articles));
log(firstLetter(articles));
